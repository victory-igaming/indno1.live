      ...
      <div className="max-w-2xl mx-auto px-4 py-8 admndsb_newstrm_body">
        <form onSubmit={handleSubmit} className="space-y-6 admndsb_newstrm_from">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 space-y-5 admndsb_newstrm_frombody">
            ...
            <div className="admndsb_newstrm_fromhdn">
              <label className="block text-zinc-400 text-xs uppercase tracking-widest mb-2 admndsb_newstrm_lable">Sport *</label>
            ...
            <div className="admndsb_newstrm_fromhdn">
              <label className="block text-zinc-400 text-xs uppercase tracking-widest mb-2 admndsb_newstrm_lable">YouTube URL *</label>
              <input
                title="YouTube URL"
                type="url"
            ...
            <div className="grid grid-cols-2 gap-4 ">
              <div className="admndsb_newstrm_fromhdn">
                <label className="block text-zinc-400 text-xs uppercase tracking-widest mb-2 admndsb_newstrm_lable">Team 1</label>
                <input
                title="Team 1"
                  type="text"
                  value={form.team1}
              ...
              <div className="admndsb_newstrm_fromhdn">
                <label className="block text-zinc-400 text-xs uppercase tracking-widest mb-2 admndsb_newstrm_lable">Team 2</label>
                <input
                 title="Team 2"
                  type="text"
                  value={form.team2}
